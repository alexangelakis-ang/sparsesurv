...
#' @param delta_prior_mean Prior mean for delta coefficients of the zero inflation part (default = 0).
#' @param delta_prior_sd   Prior SD   for delta coefficients of the zero inflation part (default = 10).
